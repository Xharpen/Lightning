...
return [
    ...
    'searchByIpAddress' => [
        'ko' => 'IP 주소로 검색',
        'en' => 'Search by IP Address',
    ],
    'passCurrentStep' => [
        'ko' => '이 단계를 생략',
        'en' => 'Pass Current Step',
    ],
    'enable' => [
        'ko' => '가능',
        'en' => 'Enable',
    ...
    'enterYourPassword' => [
        'ko' => '작성할 때 등록 된 비밀번호를 입력합니다.',
        'en' => 'Enter the registered password when you want to create.',
    ],
    'adminId' => [
        'ko' => '관리자 ID',
        'en' => 'Admin ID',
    ...
    'tokenMismatch' => [
        'ko' => '시간이 경과되어 세션이 만료되었습니다. 새로고침 후 다시 실행하시기 바랍니다.',
        'en' => 'The elapsed time is expired session. Please re-run after the refresh.',
    ],
    'pageNotFound' => [
        'ko' => '잘못된 요청입니다. 입력한 주소를 확인하시기 바랍니다.',
        'en' => 'Invalid request. Please check the entered address.',
    ],
    'systemError' => [
        'ko' => '시스템에 오류가 있습니다. 관리자에게 문의하세요.',
        'en' => 'There is an error in the system. Please contact your administrator.',
    ],
    'validatorRequired' => [
        'ko' => '필수 입력 정보가 누락되었습니다.',
        'en' => 'Required information is missing.',
    ],
    'validatorAlphanum' => [
        'ko' => '숫자와 알파벳만 입력하세요.',
        'en' => 'Please enter only numbers and the alphabet.',
    ],
    'validatorMin' => [
    ...
    'componentNotFound' => [
        ...
        'en' => '":className" class not found in ":pluginId" plugin',
    ],
    'wrongInput' => [
        'ko' => '잘못 입력되었습니다.',
    ...
    'newMenuDescription' => [
        'ko' => '생성할 메뉴의 정보를 입력하십시오',
        'en' => 'Please Enter New Menu Information'
    ],
    'createMenuTitle' => [
        'ko' => '새로운 메뉴를 추가합니다.',
        'en' => 'Add New Menu'
    ...
    'menuTitleDescription' => [
        'ko' => '메뉴의 이름은 사용자에게 노출되지 않습니다.',
        'en' => 'Guest can not see menu title '
    ],
    'menuTitlePlaceHolder' => [
        'ko' => '메뉴를 식별할 수 있도록 이름을 입력하십시오.',
        'en' => 'Enter the title for identification'
    ],
    'menuDescriptionPlaceHolder' => [
        'ko' => '이 메뉴에 대한 설명을 입력하십시오.',
        'en' => 'Enter the description for menu'
    ],
    'menuThemeDescription' => [
        'ko' => '테마를 미리 보고 클릭하여 선택할 수 있습니다.',
        'en' => 'Select Menu Default Theme'
    ],
    'menuThemeInheritMode' => [
        'ko' => '상위 테마와 동일하게 지정합니다.',
        'en' => 'Parent Same Theme'
    ],
    'newItem' => [
        'ko' => '새로운 아이템',
        'en' => 'New Item'
    ...
    'newItemDescription' => [
        'ko' => '새로운 메뉴 아이템을 추가합니다.',
        'en' => 'Please Enter New Menu Item Information'
    ],
    'itemActivatedDescription' => [
        'ko' => '이 메뉴 아이템의 활성/비활성을 결정합니다.',
        'en' => 'Check Item Activation or Deactivation'
    ],
    ...
    'itemTargetOption_newWindow' => [
        'ko' => '새창으로 열기',
        'en' => 'New Window'
    ],
    'itemTargetOption_parentFrame' => [
        'ko' => '부모 프레임에서 열기',
        'en' => 'Parent Frame'
    ],
    'itemTargetOption_topFrame' => [
        'ko' => '최상위 프레임에서 열기',
        'en' => 'Top Frame'
    ],
    ...
    'deleteMenuConfig' => [
        'ko' => "':title' 메뉴 삭제를 확인합니다.",
        'en' => "Confirm deletion ':title'"
    ],
    'deleteItem' => [
        'ko' => '아이템 삭제하기',
        'en' => 'Delete Item'
    ...
    'selectItemTypeDescription' => [
        'ko' => '생성할 메뉴의 타입을 선택하십시오',
        'en' => 'Select Menu Item Type'
    ],
    'menuItemType' => [
        'ko' => '메뉴 아이템 타입',
        'en' => 'MenuItem Type'
    ...
    'canSetupEmails' => [
        'ko' => '기본 이메일을 설정하고 관리할 수 있습니다.',
        'en' => 'You can setup and manage your emails'
    ],
    'confirmDelete' => [
        'ko' => '삭제하시겠습니까?',
        'en' => 'Delete?'
    ...
    'passwordNotRegisterd' => [
        'ko' => '아직 비밀번호가 지정되지 않았습니다. 비밀번호를 지정하시면 이메일 주소와 비밀번호를 사용하여 로그인할 수 있습니다.',
        'en' => 'Password not registerd. If register password, you can sign in with email and password.'
    ],
    'deleteAccount' => [
        'ko' => '계정 삭제',
        'en' => 'Delete account'
    ],
    'confirmNeedAccountDeletion' => [
        'ko' => '계정을 삭제할 필요가 있습니까?',
        'en' => 'Do you need to delete your account?'
    ],
    'warningAboutAccountDeletion' => [
        'ko' => '계정을 삭제하면 콘텐츠 접근이 제한되고 회원정보와 연계된 모든 데이터가 제거됩니다.',
        'en' => 'If you delete your account,
                all of your contents will be deleted and access to them will be restricted.'
    ],
    'deleteOk' => [
        'ko' => '예. 삭제합니다.',
        'en' => 'Ok. delete.'
